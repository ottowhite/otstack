...
class SimpleBranch(Branch):
    ...
    def merge(self, other_branch: Branch) -> bool:
        raise NotImplementedError(
            "SimpleBranch does not support merge. "
            "Use LocalBranch for local git operations."
        )

    def pull(self) -> bool:
        raise NotImplementedError(
            "SimpleBranch does not support pull. "
            "Use LocalBranch for local git operations."
        )
    ...
    def push(self) -> bool:
        raise NotImplementedError(
            "SimpleBranch does not support push. "
            "Use LocalBranch for local git operations."
        )

    def has_merge_conflicts(self) -> bool:
        raise NotImplementedError(
            "SimpleBranch does not support has_merge_conflicts. "
            "Use LocalBranch for local git operations."
        )

    def abort_merge(self) -> None:
        raise NotImplementedError(
            "SimpleBranch does not support abort_merge. "
            "Use LocalBranch for local git operations."
        )
